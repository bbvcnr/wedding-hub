...
import { Modal, View, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, StyleSheet, ActivityIndicator, ScrollView } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  sheet: { borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 0, maxHeight: '85%' },
  ...
  actions: { flexDirection: 'row', gap: 12, marginTop: 16, marginBottom: 40 },
  btn: { flex: 1 },
});
